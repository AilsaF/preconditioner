...
def compute_score_raw(dataset, imageSize, dataroot, sampleSize, batchSize,
                      ...
                      conv_model='inception_v3', workers=4):
...
import os
netG, _ = hignorm_networks.getGD('resnet', 'cifar', 256, 256, dim_z=128, image_size=32, ignoreD=True)
folder = 'ie510result/cifar_structresnet_GfeatureNum256_DfeatureNum256_losshinge/'
exp_ = 'vanilla_CIFAR_size32_dlr0.0002_glr0.0002_diter1_giter1_b10.5_b20.999_Gnumfea256_Dnumfea256_batchsize64_sniter1_usepolarTrueiter3_ematrickPN3+orthoD'
model_path = os.path.join(folder, exp_, 'models/G_epoch{}.pth'.format(100000))
netG.load_state_dict(torch.load(model_path))
score = compute_score_raw('cifar10', 32, '/home/illini/rsgan/DATA/cifar10/', 64, 64, 'real/', 'fake/', netG.cuda(), 128, 'inception_v3')
print(score)
