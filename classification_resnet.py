...
args.save_dir = "cifar10_classifiction_results/cifar_{}_pc{}_lr{}_bs{}_epoch{}_cutmixprob{}_cosine_noBN_withscalar_init_diy2_seed{}".format(
...
# export MKL_NUM_THREADS=4 && CUDA_VISIBLE_DEVICES=0 python classification_resnet.py 


# export MKL_NUM_THREADS=4 && CUDA_VISIBLE_DEVICES=2 python classification_resnet.py --arch resnet110 --PC --skip --lr 0.01 --save-dir cifar_classification_resnet110_skip_noBN_APC > cifar_classification_resnet110_skip_noBN_APC.txt &