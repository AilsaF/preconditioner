...
def add_argumentsdata(parser: argparse.ArgumentParser):
    group = parser.add_argument_group('Dataset Option')
    group.add_argument('--dataset', metavar='NAME', default='ImageNet')
    group.add_argument('--dataset-root', metavar='PATH', default=os.path.expanduser('/data01/tf6/DATA/imagenet/'),
                       help='The directory which contains needed dataset.')
    group.add_argument('-b', '--batch-size', default=[256], metavar='NUMs',
    ...
    group.add_argument('--im-size',  default=(256, 256), metavar='NUMs',
...
def add_arguments(parser: argparse.ArgumentParser):
    group = add_argumentsdata(parser)
    group.add_argument('--dali', default=has_DALI,  metavar='BOOL',
...
def get_dataset_loader(train, transforms=None, target_transform=None, root='/data01/tf6/DATA/imagenet'):
    im_size = (3, 256, 256)
    dataset_classes = 1000
