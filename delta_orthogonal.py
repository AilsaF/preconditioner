import torch
# ref: https://github.com/JiJingYu/delta_orthogonal_init_pytorch/blob/master/demo.py
# backup: https://github.com/yl-1993/ConvDeltaOrthogonal-Init/blob/master/_ext/nn/init.py
