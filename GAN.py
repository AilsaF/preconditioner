...
def getSavePath():
    ...
    dir_name = dir_name + 'ie510result/{}_struct{}_GfeatureNum{}_DfeatureNum{}_loss{}_deep7-2/'.format(args.dataset,
...
# export MKL_NUM_THREADS=4 && CUDA_VISIBLE_DEVICES=5 python GAN.py --dataset cifar --batch_size 64 --structure resnet --Gnum_features 512 --Dnum_features 256 --num_iters 100000  --losstype hinge --pclevel 0 --save_freq 2000 --specname deepblock --d_freq 5 --apc &
