...
# export MKL_NUM_THREADS=4 && CUDA_VISIBLE_DEVICES=1 python GAN.py --dataset cifar --batch_size 64 --structure resnet --Gnum_features 512 --Dnum_features 128 --num_iters 100000  --losstype hinge --pclevel 0 --save_freq 2000 --specname deepblock --d_freq 5 &
